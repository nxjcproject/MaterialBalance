<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckInformation.aspx.cs" Inherits="MaterialBalance.Web.UI_MaterialBalance.Inventory.CheckInformation" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript" src="../js/page/Inventory/CheckInformation.js"charset="utf-8"></script>
</head>
<body>
     <div class="easyui-layout" data-options="fit:true,border:false">
        ...
        <!-- 图表开始 -->
        <div id="toolbar_CheckInformation" style="display: none;">
            <table>
                <tr>
                    <td>
                        <table>
                            <tr>
                                ...
                                <td class="queryDate"><a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true"
                                    onclick="QueryCheckInformation();">查询</a>
                                </td>               
                            </tr>
                        </table>
                    </td>
        ...
        <div id="reportTable" class="easyui-panel" data-options="region:'center', border:true, collapsible:true, split:false">
            <table id="gridMain_CheckInformation"></table>
        </div>
        <!-- 图表结束 -->
    </div>
